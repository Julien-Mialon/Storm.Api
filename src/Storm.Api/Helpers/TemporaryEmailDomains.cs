namespace Storm.Api.Helpers;

public static class TemporaryEmailDomains
{
	...
	public static bool IsTemporaryEmailDomain(this string email)
	{
		...
		if (domain.Contains('.') is false || !char.IsLetterOrDigit(domain[0]) || !char.IsLetterOrDigit(domain[^1]))
		{
			return true;
		}
